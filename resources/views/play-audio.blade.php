...
<div class="w3-row">
	<div class="w3-col m8" style="padding-right:10px;">
		...
		<div class="w3-row">
			...
			<div class="w3-col m12 margin-top-10">
				<button class="w3-btn w3-purple w3-round"><i class="fa fa-heart-o" aria-hidden="true"></i> Thích</button>
	...
	<div class="w3-col m4">
		<div style="color:#9C27B0;font-size:18px;">GỢI Ý</div>
