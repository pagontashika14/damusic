<header class="main-header">
	...
	<a href="/" class="logo">
		...
		<span class="logo-mini"><i class="fa fa-music"></i></span>
		<!-- logo for regular state and mobile devices -->
		<span class="logo-lg"><i class="fa fa-music"></i> <b>Music</b>4ME</span>
	</a>
			...
			<ul class="nav navbar-nav">
							...
							<ul class="menu">
								<li><!-- start message -->
									<a href="#">
										<div class="pull-left">
											<!-- User Image -->
											<img src="{{ asset('admin-lte/dist/img/user2-160x160.jpg',env('HTTPS_ASSET')) }}" class="img-circle" alt="User Image">
										</div>
				...
				<li class="dropdown user user-menu">
					...
					<a href="#" class="dropdown-toggle" data-toggle="dropdown">
						...
						{{-- <img src="{{ asset('admin-lte/dist/img/user2-160x160.jpg',env('HTTPS_ASSET')) }}" class="user-image" alt="User Image"> --}}
					...
					<ul class="dropdown-menu">
						...
						<li class="user-footer">
							<div class="pull-left">
								<a href="#" class="btn btn-default btn-flat">Đăng ký</a>
							</div>
